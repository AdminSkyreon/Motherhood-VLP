...
export default function Footer({ data }) {
  ...
  return (
    <footer className="w-full bg-[#111827] text-gray-400 py-4 px-4 text-center relative overflow-x-hidden">
      <div className="max-w-4xl mx-auto flex flex-col items-center justify-center text-xs md:text-sm gap-1.5 w-full">
        
        {/* Top Line: Copyright, Hospital Name, Branch & Phone (Visible everywhere) */}
        <p className="text-gray-300 w-full px-2 leading-relaxed">
          &copy; 2026 {data.hospitalName} &bull; {data.branch} &bull; {data.phone}
        </p>
