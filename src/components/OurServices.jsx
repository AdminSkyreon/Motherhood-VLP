...
export default function OurServices({ data }) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10 flex flex-col items-center w-full">
        ...
        {/* Services Grid */}
        <div className="w-full grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-5 justify-items-center">
            ...
            return (
              <div 
                ...
                className={`bg-white/95 cursor-pointer backdrop-blur-md rounded-2xl shadow-[0_6px_22px_rgba(0,0,0,0.05)] border border-white/60 hover:shadow-[0_10px_28px_rgba(219,80,112,0.12)] transition-all duration-500 flex ${
                  isLast 
                    ? `col-span-2 mx-auto w-[85%] max-w-sm flex-row px-5 py-3 lg:col-span-1 lg:w-full lg:flex-col lg:text-center lg:px-5 lg:py-5.5 lg:items-center ${isActive ? 'items-start' : 'items-center'}` 
                    : 'w-full flex-col items-center text-center px-4 py-4 lg:px-5 lg:py-5.5'
                } group transform ${
